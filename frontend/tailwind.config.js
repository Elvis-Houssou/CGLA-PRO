...
const config = {
  ...
  theme: {
    extend: {
      ...
      /* Ombres & animations "lift" */
      boxShadow: {
        lift: "0 4px 6px rgba(0,0,0,0.1)",
        "lift-hover": "0 2px 3px rgba(0,0,0,0.05)",
      },
      translate: {
        "lift-x": "2px",
        "lift-y": "-2px",
      ...
      /* Couleurs dynamiques basées sur CSS vars (RGB) */
      colors: {
      ...
      /* Animations pour les dialogs et autres composants */
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
