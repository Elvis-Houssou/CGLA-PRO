...
from app.routers import auth, users, offers, benefits, offer_benefits, subscriptions, garages, manager_section, manager_page
...
app.include_router(manager_section.router)
app.include_router(manager_page.router)
